...
def extract_and_filter_data():
    ...
    descriptions_path = '/data0/home/cddu/UniBrain/validate/OneLLM_reasoning/OneLLM_sub1.json'
...
# 1. 定义输出文件的路径
output_path = "/data0/home/cddu/UniBrain/validate/OneLLM_reasoning/OneLLM_sub1_reason.json"
