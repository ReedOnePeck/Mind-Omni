...
# chmod +x train_stage1_2/train_stage1_2.sh
...
OUTPUT_DIR="/data/home/luyizhuo/Datastation_lyz/Models/UniBrain/train_stage1_2/"
...
RESUME_FROM_CHECKPOINT="/data/home/luyizhuo/Datastation_lyz/Models/UniBrain/train_stage1_with_encoding/checkpoint-16500"
...
PYTHON_PATH="./" accelerate launch \
    ...
    train_stage1_2/train_mind_omni_stage1_2.py \
