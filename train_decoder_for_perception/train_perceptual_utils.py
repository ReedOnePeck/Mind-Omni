...
class fMRI_tokenizer_TrainDataset(Dataset):
    def __init__(self, fMRI_single_root, img_feature, text_feature, text_hidden_root):
        super().__init__()
...
class fMRI_tokenizer_ValDataset(Dataset):
    def __init__(self, fMRI_single_root, fMRI_multi_root, img_feature, text_feature, text_hidden_root):
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        sample_dict = {
            ...
            'image_clip_feature': image_clip_feature,
            'text_clip_feature': text_clip_feature,
            'text_hidden_state': text_hidden_dict.get('hidden_state', text_hidden_dict.get('last_hidden_state'))[1:,:],
